...
import com.example.bodyboost.databinding.ActivityWeightBinding;
...
public class WeightActivity extends AppCompatActivity {
    ...
    String currentWeight, goalWeight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null) {
            ...
            if (checkFrom.contentEquals("auth")){
                ...
                // Set initial values for current and goal weight
                binding.etCurrentWeight.setText(HelperClass.users.getCurrentWeight());
                binding.etGoalWeight.setText(HelperClass.users.getTargetWeight());
            }
        }
        ...
        binding.tvSkip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WeightActivity.this, FatActivity.class);
        ...
        binding.btnSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isValidated()){
                    ...
                    users.setCurrentWeight(currentWeight);
                    users.setTargetWeight(goalWeight);
                    Map<String, Object> update = new HashMap<String, Object>();
                    update.put("currentWeight", currentWeight);
                    update.put("targetWeight", goalWeight);
                    dbRefUsers.child(auth.getCurrentUser().getUid()).updateChildren(update).addOnCompleteListener(task -> {
                        ...
                        // If opened from authentication, navigate to FatActivity
                        if (checkFrom.contentEquals("auth")){
                            Intent intent = new Intent(WeightActivity.this, FatActivity.class);
    ...
    // Validate user input for current and goal weight
    private Boolean isValidated(){
        currentWeight = binding.etCurrentWeight.getText().toString().trim();
        goalWeight = binding.etGoalWeight.getText().toString().trim();

        if (currentWeight.isEmpty() || currentWeight.contentEquals("0")){
            showMessage("Please enter current weight");
            return false;
        }
        if (goalWeight.isEmpty() || goalWeight.contentEquals("0")){
            showMessage("Please enter goal weight");
            return false;
        }
